...
public class NoleerCommand extends Command {
    public NoleerCommand() {
        super(null, new String[] {"noleer"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for NoleerCommand
        gameClient.getHabbo().whisper("Comando NoleerCommand ejecutado con éxito.");
        return true;
    }
}
