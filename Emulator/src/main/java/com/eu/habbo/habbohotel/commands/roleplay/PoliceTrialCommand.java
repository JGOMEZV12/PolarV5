...
public class PoliceTrialCommand extends Command {
    public PoliceTrialCommand() {
        super("job", new String[] {"ptrial", "unptrial"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for PoliceTrialCommand
        gameClient.getHabbo().whisper("Comando PoliceTrialCommand ejecutado con éxito.");
        return true;
    }
}
