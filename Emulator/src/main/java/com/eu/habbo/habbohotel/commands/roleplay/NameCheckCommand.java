...
public class NameCheckCommand extends Command {
    public NameCheckCommand() {
        super("staff", new String[] {"checkname", "namecheck"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for NameCheckCommand
        gameClient.getHabbo().whisper("Comando NameCheckCommand ejecutado con éxito.");
        return true;
    }
}
