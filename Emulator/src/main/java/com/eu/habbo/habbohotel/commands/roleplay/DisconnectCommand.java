...
public class DisconnectCommand extends Command {
    public DisconnectCommand() {
        super("staff", new String[] {"dc", "disconnect"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for DisconnectCommand
        gameClient.getHabbo().whisper("Comando DisconnectCommand ejecutado con éxito.");
        return true;
    }
}
