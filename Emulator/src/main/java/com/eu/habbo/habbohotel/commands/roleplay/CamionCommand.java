...
public class CamionCommand extends Command {
    public CamionCommand() {
        super("rp", new String[] {"basura"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for CamionCommand
        gameClient.getHabbo().whisper("Comando CamionCommand ejecutado con éxito.");
        return true;
    }
}
