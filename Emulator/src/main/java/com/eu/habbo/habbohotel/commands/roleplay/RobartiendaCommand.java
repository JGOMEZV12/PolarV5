...
public class RobartiendaCommand extends Command {
    public RobartiendaCommand() {
        super("rp", new String[] {"robartienda"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando RobartiendaCommand ejecutado con éxito.");
        return true;
    }
}
