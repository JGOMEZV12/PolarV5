...
public class HtmlPageCommand extends Command {
    public HtmlPageCommand() {
        super("staff", new String[] {"page"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando HtmlPageCommand ejecutado con éxito.");
        return true;
    }
}
