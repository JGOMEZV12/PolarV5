...
public class GangCaptureCommand extends Command {
    public GangCaptureCommand() {
        super("gang", new String[] {"gcapture"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for GangCaptureCommand
        gameClient.getHabbo().whisper("Comando GangCaptureCommand ejecutado con éxito.");
        return true;
    }
}
