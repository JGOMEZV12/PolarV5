...
public class BaulCommand extends Command {
    public BaulCommand() {
        super("vehicle", new String[] {"baul"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for BaulCommand
        gameClient.getHabbo().whisper("Comando BaulCommand ejecutado con éxito.");
        return true;
    }
}
