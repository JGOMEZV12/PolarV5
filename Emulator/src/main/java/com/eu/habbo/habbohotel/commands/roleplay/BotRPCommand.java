...
public class BotRPCommand extends Command {
    public BotRPCommand() {
        super("staff", new String[] {"coordbot"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for BotRPCommand
        gameClient.getHabbo().whisper("Comando BotRPCommand ejecutado con éxito.");
        return true;
    }
}
