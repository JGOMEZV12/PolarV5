...
public class MasajeCommand extends Command {
    public MasajeCommand() {
        super("rp", new String[] {"masaje"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for MasajeCommand
        gameClient.getHabbo().whisper("Comando MasajeCommand ejecutado con éxito.");
        return true;
    }
}
