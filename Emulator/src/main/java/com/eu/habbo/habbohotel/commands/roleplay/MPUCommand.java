...
public class MPUCommand extends Command {
    public MPUCommand() {
        super("staff", new String[] {"mpu"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for MPUCommand
        gameClient.getHabbo().whisper("Comando MPUCommand ejecutado con éxito.");
        return true;
    }
}
