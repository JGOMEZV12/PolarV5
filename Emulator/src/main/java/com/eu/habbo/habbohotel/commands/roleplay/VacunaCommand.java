...
public class VacunaCommand extends Command {
    public VacunaCommand() {
        super("job", new String[] {"vacuna"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for VacunaCommand
        gameClient.getHabbo().whisper("Comando VacunaCommand ejecutado con éxito.");
        return true;
    }
}
