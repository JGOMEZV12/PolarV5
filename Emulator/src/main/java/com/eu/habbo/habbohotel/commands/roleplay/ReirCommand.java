...
public class ReirCommand extends Command {
    public ReirCommand() {
        super("rp", new String[] {"reir"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ReirCommand
        gameClient.getHabbo().whisper("Comando ReirCommand ejecutado con éxito.");
        return true;
    }
}
