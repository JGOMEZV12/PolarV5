...
public class HotRoomsCommand extends Command {
    public HotRoomsCommand() {
        super(null, new String[] {"hr", "salasactivas"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for HotRoomsCommand
        gameClient.getHabbo().whisper("Comando HotRoomsCommand ejecutado con éxito.");
        return true;
    }
}
