...
public class OralCommand extends Command {
    public OralCommand() {
        super("rp", new String[] {"oral"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for OralCommand
        gameClient.getHabbo().whisper("Comando OralCommand ejecutado con éxito.");
        return true;
    }
}
