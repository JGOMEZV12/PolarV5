...
public class SetStatCommand extends Command {
    public SetStatCommand() {
        super("staff", new String[] {"setenergy", "sethp", "sethunger", "sethygiene", "setstat"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for SetStatCommand
        gameClient.getHabbo().whisper("Comando SetStatCommand ejecutado con éxito.");
        return true;
    }
}
