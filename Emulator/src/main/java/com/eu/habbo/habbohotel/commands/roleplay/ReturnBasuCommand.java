...
public class ReturnBasuCommand extends Command {
    public ReturnBasuCommand() {
        super(null, new String[] {"descargarcamion"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ReturnBasuCommand
        gameClient.getHabbo().whisper("Comando ReturnBasuCommand ejecutado con éxito.");
        return true;
    }
}
