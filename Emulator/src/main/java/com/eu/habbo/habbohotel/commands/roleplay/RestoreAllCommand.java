...
public class RestoreAllCommand extends Command {
    public RestoreAllCommand() {
        super("staff", new String[] {"restoreall"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for RestoreAllCommand
        gameClient.getHabbo().whisper("Comando RestoreAllCommand ejecutado con éxito.");
        return true;
    }
}
