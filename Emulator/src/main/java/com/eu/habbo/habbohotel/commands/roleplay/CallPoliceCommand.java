...
public class CallPoliceCommand extends Command {
    public CallPoliceCommand() {
        super("rp", new String[] {"911", "llamarpolicia"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for CallPoliceCommand
        gameClient.getHabbo().whisper("Comando CallPoliceCommand ejecutado con éxito.");
        return true;
    }
}
