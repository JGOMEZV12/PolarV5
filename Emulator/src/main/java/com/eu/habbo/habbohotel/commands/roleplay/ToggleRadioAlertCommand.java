...
public class ToggleRadioAlertCommand extends Command {
    public ToggleRadioAlertCommand() {
        super("job", new String[] {"toggleradio", "tradio"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ToggleRadioAlertCommand
        gameClient.getHabbo().whisper("Comando ToggleRadioAlertCommand ejecutado con éxito.");
        return true;
    }
}
