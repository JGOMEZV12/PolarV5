...
public class BanVIPCommand extends Command {
    public BanVIPCommand() {
        super("staff", new String[] {"banvip"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando BanVIPCommand ejecutado con éxito.");
        return true;
    }
}
