...
public class CheckMinutesCommand extends Command {
    public CheckMinutesCommand() {
        super("job", new String[] {"verminutos"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando CheckMinutesCommand ejecutado con éxito.");
        return true;
    }
}
