...
public class PonerCommand extends Command {
    public PonerCommand() {
        super("vip", new String[] {"poner"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for PonerCommand
        gameClient.getHabbo().whisper("Comando PonerCommand ejecutado con éxito.");
        return true;
    }
}
