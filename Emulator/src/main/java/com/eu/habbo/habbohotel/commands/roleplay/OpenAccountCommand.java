...
public class OpenAccountCommand extends Command {
    public OpenAccountCommand() {
        super("job", new String[] {"abrircuenta"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for OpenAccountCommand
        gameClient.getHabbo().whisper("Comando OpenAccountCommand ejecutado con éxito.");
        return true;
    }
}
