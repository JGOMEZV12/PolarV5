...
public class ChangeClassCommand extends Command {
    public ChangeClassCommand() {
        super(null, new String[] {"cambiarclase"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ChangeClassCommand
        gameClient.getHabbo().whisper("Comando ChangeClassCommand ejecutado con éxito.");
        return true;
    }
}
