...
public class GiveDucketsCommand extends Command {
    public GiveDucketsCommand() {
        super("staff", new String[] {"duckets"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando GiveDucketsCommand ejecutado con éxito.");
        return true;
    }
}
