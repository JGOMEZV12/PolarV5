...
public class FlagOtherCommand extends Command {
    public FlagOtherCommand() {
        super("staff", new String[] {"flag", "flagother"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando FlagOtherCommand ejecutado con éxito.");
        return true;
    }
}
