...
public class MyNumberCommand extends Command {
    public MyNumberCommand() {
        super(null, new String[] {"minumero"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for MyNumberCommand
        gameClient.getHabbo().whisper("Comando MyNumberCommand ejecutado con éxito.");
        return true;
    }
}
