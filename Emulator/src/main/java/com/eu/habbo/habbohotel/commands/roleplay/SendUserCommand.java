...
public class SendUserCommand extends Command {
    public SendUserCommand() {
        super("staff", new String[] {"senduser"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for SendUserCommand
        gameClient.getHabbo().whisper("Comando SendUserCommand ejecutado con éxito.");
        return true;
    }
}
