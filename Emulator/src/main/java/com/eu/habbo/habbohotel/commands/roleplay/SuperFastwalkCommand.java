...
public class SuperFastwalkCommand extends Command {
    public SuperFastwalkCommand() {
        super("staff", new String[] {"sfastwalk"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for SuperFastwalkCommand
        gameClient.getHabbo().whisper("Comando SuperFastwalkCommand ejecutado con éxito.");
        return true;
    }
}
