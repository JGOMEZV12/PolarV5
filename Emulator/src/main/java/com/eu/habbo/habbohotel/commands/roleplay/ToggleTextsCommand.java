...
public class ToggleTextsCommand extends Command {
    public ToggleTextsCommand() {
        super(null, new String[] {"apagartelefono"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando ToggleTextsCommand ejecutado con éxito.");
        return true;
    }
}
