...
public class AccountCheckCommand extends Command {
    public AccountCheckCommand() {
        super("staff", new String[] {"accountcheck", "checkaccount"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for AccountCheckCommand
        gameClient.getHabbo().whisper("Comando AccountCheckCommand ejecutado con éxito.");
        return true;
    }
}
