...
public class GiveRightsCommand extends Command {
    public GiveRightsCommand() {
        super(null, new String[] {"darpermisos"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando GiveRightsCommand ejecutado con éxito.");
        return true;
    }
}
