...
public class Weapon {
    ...
    public String getFiringText() {
        return firingText;
    }

    public void setFiringText(String firingText) {
        this.firingText = firingText;
    }
    ...
    public String getUnEquipText() {
        return unEquipText;
    }

    public void setUnEquipText(String unEquipText) {
        this.unEquipText = unEquipText;
    }
    ...
    public int getBaulCar() {
        return baulCar;
    }

    public void setBaulCar(int baulCar) {
        this.baulCar = baulCar;
    }
