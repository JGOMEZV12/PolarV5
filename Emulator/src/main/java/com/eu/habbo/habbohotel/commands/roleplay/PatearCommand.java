...
public class PatearCommand extends Command {
    public PatearCommand() {
        super("rp", new String[] {"patear"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for PatearCommand
        gameClient.getHabbo().whisper("Comando PatearCommand ejecutado con éxito.");
        return true;
    }
}
