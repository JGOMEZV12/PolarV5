...
public class ChangeLogCommand extends Command {
    public ChangeLogCommand() {
        super(null, new String[] {"actualizaciones"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ChangeLogCommand
        gameClient.getHabbo().whisper("Comando ChangeLogCommand ejecutado con éxito.");
        return true;
    }
}
