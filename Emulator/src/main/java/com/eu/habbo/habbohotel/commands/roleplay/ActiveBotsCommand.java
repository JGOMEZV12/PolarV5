...
public class ActiveBotsCommand extends Command {
    public ActiveBotsCommand() {
        super("staff", new String[] {"activebots"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando ActiveBotsCommand ejecutado con éxito.");
        return true;
    }
}
