...
public class SuperPushCommand extends Command {
    public SuperPushCommand() {
        super("staff", new String[] {"spush"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for SuperPushCommand
        gameClient.getHabbo().whisper("Comando SuperPushCommand ejecutado con éxito.");
        return true;
    }
}
