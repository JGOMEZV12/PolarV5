...
public class EmptyItemsCommand extends Command {
    public EmptyItemsCommand() {
        super(null, new String[] {"emptyitems"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando EmptyItemsCommand ejecutado con éxito.");
        return true;
    }
}
