...
public class GiveBadgeCommand extends Command {
    public GiveBadgeCommand() {
        super("staff", new String[] {"givebadge"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for GiveBadgeCommand
        gameClient.getHabbo().whisper("Comando GiveBadgeCommand ejecutado con éxito.");
        return true;
    }
}
