...
public class OffersCommand extends Command {
    public OffersCommand() {
        super("rp", new String[] {"ofertas"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for OffersCommand
        gameClient.getHabbo().whisper("Comando OffersCommand ejecutado con éxito.");
        return true;
    }
}
