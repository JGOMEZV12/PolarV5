...
public class RoomIDCommand extends Command {
    public RoomIDCommand() {
        super(null, new String[] {"estoy"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for RoomIDCommand
        gameClient.getHabbo().whisper("Comando RoomIDCommand ejecutado con éxito.");
        return true;
    }
}
