...
public class GiveVIPCommand extends Command {
    public GiveVIPCommand() {
        super("staff", new String[] {"givevip"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for GiveVIPCommand
        gameClient.getHabbo().whisper("Comando GiveVIPCommand ejecutado con éxito.");
        return true;
    }
}
