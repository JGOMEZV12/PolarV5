...
public class StopSHCommand extends Command {
    public StopSHCommand() {
        super("vip", new String[] {"stopsh"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for StopSHCommand
        gameClient.getHabbo().whisper("Comando StopSHCommand ejecutado con éxito.");
        return true;
    }
}
