...
public class DriveCommand extends Command {
    public DriveCommand() {
        super("vehicle", new String[] {"detener", "manejar", "nomanejar"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for DriveCommand
        gameClient.getHabbo().whisper("Comando DriveCommand ejecutado con éxito.");
        return true;
    }
}
