...
public class MearCommand extends Command {
    public MearCommand() {
        super("rp", new String[] {"mear"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for MearCommand
        gameClient.getHabbo().whisper("Comando MearCommand ejecutado con éxito.");
        return true;
    }
}
