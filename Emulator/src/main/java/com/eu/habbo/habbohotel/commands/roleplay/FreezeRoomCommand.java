...
public class FreezeRoomCommand extends Command {
    public FreezeRoomCommand() {
        super("staff", new String[] {"freezeroom"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for FreezeRoomCommand
        gameClient.getHabbo().whisper("Comando FreezeRoomCommand ejecutado con éxito.");
        return true;
    }
}
