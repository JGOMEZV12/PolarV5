...
public class ReturnCamCommand extends Command {
    public ReturnCamCommand() {
        super("job", new String[] {"entregarcamion"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ReturnCamCommand
        gameClient.getHabbo().whisper("Comando ReturnCamCommand ejecutado con éxito.");
        return true;
    }
}
