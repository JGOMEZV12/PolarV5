...
public class ToDoCommand extends Command {
    public ToDoCommand() {
        super("staff", new String[] {"addtodo", "deletetodo", "deltodo", "tda", "tdd", "todo", "todoadd", "tododel", "tododelete"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ToDoCommand
        gameClient.getHabbo().whisper("Comando ToDoCommand ejecutado con éxito.");
        return true;
    }
}
