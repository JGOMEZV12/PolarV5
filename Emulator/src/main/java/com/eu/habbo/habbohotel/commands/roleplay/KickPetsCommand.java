...
public class KickPetsCommand extends Command {
    public KickPetsCommand() {
        super("staff", new String[] {"kickpets"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando KickPetsCommand ejecutado con éxito.");
        return true;
    }
}
