...
public class RoomHealCommand extends Command {
    public RoomHealCommand() {
        super("staff", new String[] {"roomheal"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for RoomHealCommand
        gameClient.getHabbo().whisper("Comando RoomHealCommand ejecutado con éxito.");
        return true;
    }
}
