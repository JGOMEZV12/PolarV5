...
public class ForceSitCommand extends Command {
    public ForceSitCommand() {
        super("staff", new String[] {"forcesit"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando ForceSitCommand ejecutado con éxito.");
        return true;
    }
}
