...
public class ReloadGunCommand extends Command {
    public ReloadGunCommand() {
        super("rp", new String[] {"recargar"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ReloadGunCommand
        gameClient.getHabbo().whisper("Comando ReloadGunCommand ejecutado con éxito.");
        return true;
    }
}
