...
public class TirarBasuraCommand extends Command {
    public TirarBasuraCommand() {
        super(null, new String[] {"tirarbasura"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for TirarBasuraCommand
        gameClient.getHabbo().whisper("Comando TirarBasuraCommand ejecutado con éxito.");
        return true;
    }
}
