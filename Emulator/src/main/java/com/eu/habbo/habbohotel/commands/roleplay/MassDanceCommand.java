...
public class MassDanceCommand extends Command {
    public MassDanceCommand() {
        super("staff", new String[] {"massdance"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando MassDanceCommand ejecutado con éxito.");
        return true;
    }
}
