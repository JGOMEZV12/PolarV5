...
public class UnBlackListCommand extends Command {
    public UnBlackListCommand() {
        super("staff", new String[] {"unblacklist"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for UnBlackListCommand
        gameClient.getHabbo().whisper("Comando UnBlackListCommand ejecutado con éxito.");
        return true;
    }
}
