...
public class SendhomeCommand extends Command {
    public SendhomeCommand() {
        super("job", new String[] {"sendhome"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for SendhomeCommand
        gameClient.getHabbo().whisper("Comando SendhomeCommand ejecutado con éxito.");
        return true;
    }
}
