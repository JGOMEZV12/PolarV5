...
public class TakeCoinsCommand extends Command {
    public TakeCoinsCommand() {
        super("staff", new String[] {"rcoins"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for TakeCoinsCommand
        gameClient.getHabbo().whisper("Comando TakeCoinsCommand ejecutado con éxito.");
        return true;
    }
}
