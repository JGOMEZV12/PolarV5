...
public class UnEquipCommand extends Command {
    public UnEquipCommand() {
        super("rp", new String[] {"desequipar", "guardar"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for UnEquipCommand
        gameClient.getHabbo().whisper("Comando UnEquipCommand ejecutado con éxito.");
        return true;
    }
}
