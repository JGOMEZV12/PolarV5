...
public class EstadoCommand extends Command {
    public EstadoCommand() {
        super(null, new String[] {"estado"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for EstadoCommand
        gameClient.getHabbo().whisper("Comando EstadoCommand ejecutado con éxito.");
        return true;
    }
}
