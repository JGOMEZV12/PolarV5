...
public class CtransferirCommand extends Command {
    public CtransferirCommand() {
        super("rp", new String[] {"ctransferir"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for CtransferirCommand
        gameClient.getHabbo().whisper("Comando CtransferirCommand ejecutado con éxito.");
        return true;
    }
}
