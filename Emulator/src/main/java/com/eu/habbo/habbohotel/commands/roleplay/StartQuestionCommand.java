...
public class StartQuestionCommand extends Command {
    public StartQuestionCommand() {
        super("staff", new String[] {"startquestion"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for StartQuestionCommand
        gameClient.getHabbo().whisper("Comando StartQuestionCommand ejecutado con éxito.");
        return true;
    }
}
