...
public class UseBidonCommand extends Command {
    public UseBidonCommand() {
        super("vehicle", new String[] {"usarbidon"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando UseBidonCommand ejecutado con éxito.");
        return true;
    }
}
