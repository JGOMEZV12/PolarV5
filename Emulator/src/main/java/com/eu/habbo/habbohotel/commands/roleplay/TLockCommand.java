...
public class TLockCommand extends Command {
    public TLockCommand() {
        super("staff", new String[] {"tlock"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for TLockCommand
        gameClient.getHabbo().whisper("Comando TLockCommand ejecutado con éxito.");
        return true;
    }
}
