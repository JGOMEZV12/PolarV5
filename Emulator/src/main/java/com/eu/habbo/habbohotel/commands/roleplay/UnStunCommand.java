...
public class UnStunCommand extends Command {
    public UnStunCommand() {
        super("job", new String[] {"desparalizar", "nospray"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for UnStunCommand
        gameClient.getHabbo().whisper("Comando UnStunCommand ejecutado con éxito.");
        return true;
    }
}
