...
public class ClearWantedCommand extends Command {
    public ClearWantedCommand() {
        super("job", new String[] {"cw", "limpiarlista"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ClearWantedCommand
        gameClient.getHabbo().whisper("Comando ClearWantedCommand ejecutado con éxito.");
        return true;
    }
}
