...
public class PincharCommand extends Command {
    public PincharCommand() {
        super("job", new String[] {"pinchar"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando PincharCommand ejecutado con éxito.");
        return true;
    }
}
