...
public class RoomReleaseCommand extends Command {
    public RoomReleaseCommand() {
        super("staff", new String[] {"roomrelease"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for RoomReleaseCommand
        gameClient.getHabbo().whisper("Comando RoomReleaseCommand ejecutado con éxito.");
        return true;
    }
}
