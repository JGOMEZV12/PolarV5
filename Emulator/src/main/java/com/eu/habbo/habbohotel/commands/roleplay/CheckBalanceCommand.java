...
public class CheckBalanceCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for CheckBalanceCommand
        gameClient.getHabbo().whisper("Comando CheckBalanceCommand ejecutado con éxito.");
        return true;
    }
}
