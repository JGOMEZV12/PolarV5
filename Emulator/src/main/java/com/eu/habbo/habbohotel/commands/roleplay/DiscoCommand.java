...
public class DiscoCommand extends Command {
    public DiscoCommand() {
        super(null, new String[] {"disco"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for DiscoCommand
        gameClient.getHabbo().whisper("Comando DiscoCommand ejecutado con éxito.");
        return true;
    }
}
