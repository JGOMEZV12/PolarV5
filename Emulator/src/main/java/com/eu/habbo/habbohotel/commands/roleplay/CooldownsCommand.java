...
public class CooldownsCommand extends Command {
    public CooldownsCommand() {
        super(null, new String[] {"cd", "cds", "cooldowns"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for CooldownsCommand
        gameClient.getHabbo().whisper("Comando CooldownsCommand ejecutado con éxito.");
        return true;
    }
}
