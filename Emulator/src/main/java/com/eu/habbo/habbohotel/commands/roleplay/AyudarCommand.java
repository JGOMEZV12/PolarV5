...
public class AyudarCommand extends Command {
    public AyudarCommand() {
        super("job", new String[] {"ayudar"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando AyudarCommand ejecutado con éxito.");
        return true;
    }
}
