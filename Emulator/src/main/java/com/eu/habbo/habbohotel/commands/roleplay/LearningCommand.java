...
public class LearningCommand extends Command {
    public LearningCommand() {
        super(null, new String[] {"leer"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for LearningCommand
        gameClient.getHabbo().whisper("Comando LearningCommand ejecutado con éxito.");
        return true;
    }
}
