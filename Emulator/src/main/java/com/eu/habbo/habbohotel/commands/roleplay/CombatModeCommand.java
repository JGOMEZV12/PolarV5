...
public class CombatModeCommand extends Command {
    public CombatModeCommand() {
        super("rp", new String[] {"cmode", "modocombate"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for CombatModeCommand
        gameClient.getHabbo().whisper("Comando CombatModeCommand ejecutado con éxito.");
        return true;
    }
}
