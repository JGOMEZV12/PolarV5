...
public class ManosCommand extends Command {
    public ManosCommand() {
        super("rp", new String[] {"manos"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for ManosCommand
        gameClient.getHabbo().whisper("Comando ManosCommand ejecutado con éxito.");
        return true;
    }
}
