...
public class Fist implements ICombat {
    private static final Logger LOGGER = LoggerFactory.getLogger(Fist.class);
    ...
    public int getCoins(GameClient targetClient) {
        ...
        return targetClient.getHabbo().getHabboInfo().getCredits() / 4;
    }
    ...
    public void getRewards(GameClient client, GameClient targetClient, String combatType) {
        ...
        client.getHabbo().whisper("¡Has ganado " + exp + " de experiencia de Roleplay!");
