...
public class StopTranslateCommand extends Command {
    public StopTranslateCommand() {
        super("rp", new String[] {"stranslate"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for StopTranslateCommand
        gameClient.getHabbo().whisper("Comando StopTranslateCommand ejecutado con éxito.");
        return true;
    }
}
