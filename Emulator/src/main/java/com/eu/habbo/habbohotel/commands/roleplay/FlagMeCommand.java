...
public class FlagMeCommand extends Command {
    public FlagMeCommand() {
        super("vip", new String[] {"flagme"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for FlagMeCommand
        gameClient.getHabbo().whisper("Comando FlagMeCommand ejecutado con éxito.");
        return true;
    }
}
