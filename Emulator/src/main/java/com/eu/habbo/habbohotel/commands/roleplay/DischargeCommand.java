...
public class DischargeCommand extends Command {
    public DischargeCommand() {
        super("job", new String[] {"atenderpaciente", "revivir"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for DischargeCommand
        gameClient.getHabbo().whisper("Comando DischargeCommand ejecutado con éxito.");
        return true;
    }
}
