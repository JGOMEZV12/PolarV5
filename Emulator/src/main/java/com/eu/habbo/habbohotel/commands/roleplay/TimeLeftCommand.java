...
public class TimeLeftCommand extends Command {
    public TimeLeftCommand() {
        super(null, new String[] {"timeleft"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for TimeLeftCommand
        gameClient.getHabbo().whisper("Comando TimeLeftCommand ejecutado con éxito.");
        return true;
    }
}
