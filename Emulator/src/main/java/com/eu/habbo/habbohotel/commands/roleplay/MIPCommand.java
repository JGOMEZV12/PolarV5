...
public class MIPCommand extends Command {
    public MIPCommand() {
        super("staff", new String[] {"mip"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for MIPCommand
        gameClient.getHabbo().whisper("Comando MIPCommand ejecutado con éxito.");
        return true;
    }
}
