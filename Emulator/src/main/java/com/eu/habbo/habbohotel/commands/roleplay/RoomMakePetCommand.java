...
public class RoomMakePetCommand extends Command {
    public RoomMakePetCommand() {
        super("staff", new String[] {"roomtransform"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        gameClient.getHabbo().whisper("Comando RoomMakePetCommand ejecutado con éxito.");
        return true;
    }
}
