...
public class TeamoCommand extends Command {
    public TeamoCommand() {
        super("rp", new String[] {"teamo"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for TeamoCommand
        gameClient.getHabbo().whisper("Comando TeamoCommand ejecutado con éxito.");
        return true;
    }
}
