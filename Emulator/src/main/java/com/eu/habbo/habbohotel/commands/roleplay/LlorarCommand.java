...
public class LlorarCommand extends Command {
    public LlorarCommand() {
        super("rp", new String[] {"llorar"});
    }
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        // Command execution logic for LlorarCommand
        gameClient.getHabbo().whisper("Comando LlorarCommand ejecutado con éxito.");
        return true;
    }
}
